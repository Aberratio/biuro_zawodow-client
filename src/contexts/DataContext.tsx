...
interface ParticipantImportListDifference {
...
interface ParticipantFieldMappingUpdateResult extends MutationResult {
  mappings: ParticipantFieldMapping[];
  has_baseline_import: boolean;
}
interface ParticipantImportRowIssue {
  row_number: number;
  reasons: string[];
...
interface ParticipantListResetResult extends MutationResult {
...
interface ParticipantFieldMappingsState {
  has_mapping: boolean;
  has_baseline_import: boolean;
  mappings: ParticipantFieldMapping[];
}
